...
import kimxu.volley.VolleyLog.MarkerLog;
...
public abstract class Request<T> implements Comparable<Request<T>> {
     ...
     *
     * @deprecated Use {@link #Request(int, String, kimxu.volley.Response.ErrorListener)}.
     */
    @Deprecated
    ...
    private int request;
    public Request(int method, String url,int request) {
        mMethod = method;
        mUrl = url;
    ...
    /**
     * @return this request's {@link kimxu.volley.Response.ErrorListener}.
     */
    ...
    public void deliverError(VolleyError error) {
        EventBus.getDefault().post(new KObject(error,request));
    }
